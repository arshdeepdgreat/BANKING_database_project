  ...
  <nav class="white z-depth-0">
    <div class ="container">
      ...
      <ul id="nav-mobile" class="right hide-on-small-and-down">
        <li><a href="create_new_acc.php?userid=<?php echo htmlspecialchars($userid);?>&password=<?php echo htmlspecialchars($password);?>" class="btn brand z-depth-0">Create a new bank account</a></li>
        <li><a href="login.php" class="btn brand z-depth-0">sign out</a></li>
      </ul>
    </div>
  </nav>
  <div class="container"><h4>Hello <?php echo htmlspecialchars($row['customer_name']) ?>, </h4>
  <h4> Welcome to bank</h4></div>
  
  <h3 class='center'>Accounts view</h3>
  <div>
      <h5 class="center"> USER-ID: <?php echo htmlspecialchars($userid) ?></h5>
  </div>
            ...
            <div class="card-content left">
              ...
              <div><h6>Account number: <?php echo htmlspecialchars($account['s_account_number']); ?></h6></div>
  					...
  					<div class='card-content center'>
  						<h4>Balance: <?php echo htmlspecialchars($account['balance']);?> INR</h4>
  						<div>
               -----------------     
              </div>
              </div>
              <div class='card-action right-align'>
                <a class="brand-text" target=blank_ href='savings_more_info.php?userid=<?php echo($account['userid'])?>&password=<?php echo($password);?>&s_account_number=<?php echo $account['s_account_number'] ?>'>Transactions Info</a>
