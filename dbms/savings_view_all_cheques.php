...
<nav class="white z-depth-0">
    <div class ="container">
      ...
      <a href="savings_more_info.php?userid=<?php echo($userid);?>&password=<?php echo($password);?>&s_account_number=<?php echo($account);?>" class="brand-logo brand-text">Click to go back</a>
      
    </div>
  </nav>
  <h2 class="center">All digital Cheques for manual claim</h2>
	<div class='container'>
  	<div class='row'>
  			...
  			<div class="col s12 md6">
                ...
                <div class="rounded">
                    ...
                    <div class="card content z-depth-0">
                            <h4 style = "float:left;">Amount (numeric)</h4>
